import { expectString, objectSchema, optionalObject, optionalString, schema, } from "../client.js";
export function identityProvidersTools(client) {
    return [
        {
        ...
        },
        {
            ...
            inputSchema: objectSchema({ realm: schema.string("Target realm name."), alias: schema.string("IdP alias.") }, ["realm", "alias"]),
            handler: async (input) => client.get(client.realmPath(expectString(input, "realm"), `/identity-provider/instances/${encodeURIComponent(expectString(input, "alias"))}/mapper-types`)),
        },
        {
            ...
            inputSchema: objectSchema({ realm: schema.string("Target realm name."), alias: schema.string("IdP alias.") }, ["realm", "alias"]),
            handler: async (input) => client.get(client.realmPath(expectString(input, "realm"), `/identity-provider/instances/${encodeURIComponent(expectString(input, "alias"))}/mappers`)),
        },
        {
        ...
        },
        {
            ...
            handler: async (input) => {
                ...
                const mappers = await client.get(mappersPath);
