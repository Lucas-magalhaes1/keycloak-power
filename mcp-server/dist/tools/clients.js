import { expectString, objectSchema, optionalBoolean, optionalObject, optionalStringArray, schema, } from "../client.js";
export function clientsTools(client) {
    return [
        {
            name: "list_clients",
...
async function getClient(client, realm, clientId) {
    const clientUuid = await client.resolveClientUUID(realm, clientId);
    return client.get(client.realmPath(realm, `/clients/${encodeURIComponent(clientUuid)}`));
}
