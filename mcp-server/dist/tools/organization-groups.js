import { KeycloakApiError, expectConfirmation, expectString, extractServerVersion, objectSchema, optionalString, redactSensitive, schema, versionAtLeast, } from "../client.js";
const MINIMUM_VERSION = "26.6.0";
export function organizationGroupsTools(client) {
    return [
        {
        ...
        },
        {
            ...
            inputSchema: objectSchema({
                ...orgGroupTargetSchema().properties,
            ...
            handler: async (input) => {
                ...
                if (capability.status !== "supported")
                    return capability;
                const groups = await client.get(groupsPath(client, target), { populateHierarchy: true });
...
async function organizationGroupsCapability(client) {
